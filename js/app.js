    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".mainslider")) {
                ...
                let mainsliderImages = document.querySelectorAll(".mainslider__img"), mainsliderDotts = document.querySelectorAll(".mainslider__dots .swiper-pagination-bullet");
            ...
            if (document.querySelector(".brands-slider")) new core(".brands-slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 5,
            ...
            if (document.querySelector(".img-product")) {
                let thumbsSlider = new core(".subslider-img", {
                    modules: [ Thumb ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 4,
                ...
                new core(".img-product__mainslider", {
                    modules: [ Thumb ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
        ...
        da.init();
        let menuParents = document.querySelectorAll(".menu-page__parent"), menuParentMobile = document.querySelectorAll(".menu-page__parent a"), menuPageBurger = document.querySelector(".menu-page__burger"), menuPageBody = document.querySelector(".menu-page__body"), searchSelect = document.querySelector(".search-page__title"), searchCategories = document.querySelector(".categories-search"), checkboxCategories = document.querySelectorAll(".categories-search__checkbox"), textCategory = document.querySelector("#text-category");
        if (isMobile.any()) for (let i = 0; i < menuParentMobile.length; i++) {
            const menuParent = menuParentMobile[i];
            menuParent.addEventListener("click", (function(e) {
                menuParent.parentElement.classList.toggle("_active");
                e.preventDefault();
            }));
        } else for (let i = 0; i < menuParents.length; i++) {
        ...
        for (let i = 0; i < checkboxCategories.length; i++) {
            ...
            checkboxCategory.addEventListener("change", (function(e) {
                ...
                const checkboxCategoryActive = document.querySelectorAll(".categories-search__checkbox._active");
                if (checkboxCategoryActive.length > 0) textCategory.innerHTML = "Выбрано: " + checkboxCategoryActive.length; else textCategory.innerHTML = "Везде";
            }));
        }
        window["FLS"] = true;
        isWebp();
